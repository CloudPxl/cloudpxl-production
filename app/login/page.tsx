        ...
        <div className="relative z-10 flex flex-col justify-between w-full px-12 py-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <p className="text-white/70 text-lg leading-relaxed text-pretty">
              Access your isolated tenant environment. Monitor your battle-tested stack,
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {["SOC 2 Type II", "GDPR Ready", "End-to-End Encrypted", "99.99% SLA"].map((badge) => (
                <span
                  key={badge}
                  className="text-xs font-semibold px-3 py-1.5 rounded-full border border-white/20 text-white/70"
                >
                  {badge}
                </span>
              ))}
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-black/5 space-y-6">
            <div className="space-y-2 text-center relative">
              ...
              <p className="text-[#0A0A0A]/50 text-sm text-pretty">
                {currentView === "login" && "Enter your credentials to access your enterprise environment."}
                {currentView === "register" && "Create a new account to get started with CloudPxl."}
              ...
              {currentView !== "forgot" && (
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword
                        ? <EyeOff className="h-4 w-4 text-[#0A0A0A]/40" />
                        : <Eye className="h-4 w-4 text-[#0A0A0A]/40" />
                      }
                    </Button>
                  </div>
                </div>
              ...
              {currentView === "login" && (
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="remember" className="text-sm text-[#0A0A0A]/50 cursor-pointer">
                      Remember Me
                    </Label>
                  </div>
                  <Button
              ...
              <>
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white px-2 text-[#0A0A0A]/40 tracking-widest">
